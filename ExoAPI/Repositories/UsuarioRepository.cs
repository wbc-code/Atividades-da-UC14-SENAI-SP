	...
	public class UsuarioRepository
	{
		...
		public Usuario Atualizar(int id, Usuario usuario)
        {
            ...
            {				
				...
				usuarioBuscado.Senha = new Password().Hash(usuario.Senha);
        ...
        {
			return _context.Usuarios.FirstOrDefault(u => u.Email.Equals(email) && u.Senha.Equals(new Password().Hash(senha)));
        }
	}
}
